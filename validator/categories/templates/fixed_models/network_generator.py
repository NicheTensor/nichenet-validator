from validator.validator_model.generator_model import GeneratorModel
from validator.categories.templates.fixed_models.fixed_model_config import prompting, model_name
