...
from categories.categories.general_chat.general_chat_prompts import vs_prompt, eval_prompt_1, eval_prompt_2, prompt_generation_prompts
from categories.categories.general_chat.random_seed import get_random_seeds
...
class GeneralChatConfig(SynergyCategory):
    ...
    def replace_keywords(self, text):
         text = text.replace("<seeds>",get_random_seeds())
         return text