...
class FixedModelsTemplateCategory(TemplateCategory):
    ...
    def get_question(self):
        ...
        if not question:
            question = self.validator_model.generate_text("Ask me a random question.", max_tokens=200)
        return question
    ...
    def score_response(self, testing_prompt, response):
        ...
        response = requests.post(self.confirmation_url, data=json.dumps(data), headers=headers, timeout=180)
